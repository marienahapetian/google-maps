...
<div id="hg_gmaps_no_api_key_big_notice" class="error">
	...
	<p class="hg_mui_heading"><?php _e('Once registered, simply paste your API key here and press the save button. It will activate in 5-10 minutes.','hg_gmaps');?></p>
	<div>
		<form action="" method="post">
			<label class="hg_mui_text">
				...
				<div class="hg_mui_input_block">
					<input name="hg_gmaps_api_key_input" class="hg_gmaps_api_key_input" value="" required="required" type="text"><span class="control_title"><?php _e('Input the api key here','hg_gmaps');?></span>
					<div class="hg_mui_bar"></div>
				</div>
			</label>
			<div class="hg_gmaps_apply_action"><button class="hg_gmaps_save_api_key_button hg_mui_btn hg_mui_btn_raised_green"><?php _e('Save','hg_gmaps');?></button><span class="spinner"></span></div>
		</form>
	</div>
	<p class="hg_mui_heading"><?php _e('Need help?','hg_gmaps');?> <a href="http://huge-it.com/contact-us/" target="_blank"><?php _e('Contact Us','hg_gmaps');?></a> <?php _e('and we will help you with installation.','hg_gmaps');?></p>
</div>
