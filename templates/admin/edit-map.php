...
<div class="admin_edit_section_container">
	...
	<ul class="admin_edit_section">
        ...
        Hugeit_Maps_Template_Loader::get_template( 'admin/edit-map-frontend-directions-section.php', array( 'map'=>$map ) );

        Hugeit_Maps_Template_Loader::get_template( 'admin/edit-map-locator-section.php', array( 'map' => $map ) );

        Hugeit_Maps_Template_Loader::get_template( 'admin/edit-map-kml-section.php', array( 'map' => $map ) );
