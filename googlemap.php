...
function hg_gmaps_api_key_notice(){
	...
	<div id="hg_gmaps_no_api_key_big_notice" class="error">
		...
		<div><a class="hg_mui_btn hg_mui_btn_raised_blue" href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend&keyType=CLIENT_SIDE&reusekey=true">Register your application for Google Maps API now</a></div>
